<template>
    <section>
      <iframe v-on:load="setUpFrame();" name="graph" src="../../../../../static/mxgraph/examples/ports.html" width="100%" height="100%"></iframe>
      <v-btn @click="getJson">{{ received }}</v-btn>
      <v-btn @click="storeFlow">Guardar flujo</v-btn>
      <interoperabilidad
        ref="interOp"
